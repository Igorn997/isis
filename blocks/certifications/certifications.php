                        ...
                        <div class="button-wrapper">
                          <a href="<?php echo esc_url($first_button['url']); ?>"
                            ...
                            <span class="btn-image">
                              <img src="<?php echo get_template_directory_uri(); ?>/assets/images/icons/btn-arrow.svg"
                                alt="arrow" class="arrow1" />
                              <img src="<?php echo get_template_directory_uri(); ?>/assets/images/icons/arrow-right.svg"
                                alt="arrow" class="arrow2" />
                            </span>
                          </a>
                        </div>
                        <?php endif; ?>
                        ...
                        <div class="box second">
                          ...
                          <div class="certifications-list">
                            ...
                            <div class="certifications-list-item"
                              data-id="<?php echo esc_attr($certification_card['id']); ?>"
                            ...
                            <div id="certificationModal-<?php echo esc_attr($certification_card['id']); ?>"
                              class="modal">
                                    ...
                                    <div class="left">
                                      <div class="left-text">
                                        <h2 class="modal-heading">
                                          <?php echo esc_html($certification_card['heading']); ?></h2>
                                        <p class="modal-description">
                                          <?php echo esc_html($certification_card['description']); ?></p>
                                      </div>
                                      <div class="button-wrapper">
                                        <div
                                          ...
                                          <span class="btn-image">
                                            <svg class='arrow1' width="12" height="12" viewBox="0 0 12 12" fill="none"
                                              xmlns="http://www.w3.org/2000/svg">
                                              <path
                                            ...
                                            <svg class='arrow2' width="12" height="12" viewBox="0 0 12 12" fill="none"
                                              xmlns="http://www.w3.org/2000/svg">
                                              <path
                                                d="M-7.82371e-07 3.02728L0.00811188 11.1895C0.00811193 11.652 0.308725 11.9766 0.796183 11.9766L8.96954 11.9766C9.42451 11.9766 9.73324 11.6277 9.73324 11.2382C9.73324 10.8488 9.38389 10.5161 9.00203 10.5161L6.17468 10.5161L2.20988 10.6459L3.72106 9.32341L11.7725 1.26661C11.9188 1.12059 12 0.933928 12 0.755438C12 0.365985 11.6506 0.00090316 11.2444 0.000903196C11.0575 0.000903212 10.8788 0.0657779 10.7326 0.219966L2.66489 8.26865L1.32434 9.78589L1.47055 5.99683L1.47055 2.99481C1.47055 2.61346 1.13742 2.25648 0.73933 2.25648C0.349351 2.25648 -8.20679e-07 2.58909 -7.82371e-07 3.02728Z"
                                                fill="#ffffff" />
