...
function regenerate_assets_output() {
    ...
    ?>
    <div class="wrap">
        <h1><?php _e( 'Regenerate Assets', 'starter' ) ?></h1>
        <a href="<?php echo $current_admin_page.'&regenerate=true'?>" class="page-title-action" style="margin: 10px 0;display: inline-block;"><?php _e( 'Regenerate', 'starter' ); ?></a>
    </div>
