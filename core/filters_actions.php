...
add_action( 'get_footer', 'starter_scripts_and_styles_footer');
...
if (!function_exists('after_setup_theme_function')):
	...
	if ( !function_exists('starter_scripts_and_styles_footer') ) :

		function starter_scripts_and_styles_footer() {
...
function starter_add_dashboard_notice(){
...
add_action('admin_notices', 'starter_add_dashboard_notice');

// change login logo href 
function starter_login_logo_href($url) {
    return home_url( '/' );
}
add_filter( 'login_headerurl', 'starter_login_logo_href' );
